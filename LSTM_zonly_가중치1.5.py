...
# # 기존 가중치 불러오기
# uploaded = files.upload()
# model.load_state_dict(torch.load('lstm_zOnly_class1_weight1.5_v0.pt'))
...
torch.save(model.state_dict(),
           'lstm_zOnly_class1_weight1.5_v0.pt')
print("모델 저장 완료")

# Colab 다운로드
files.download('lstm_zOnly_class1_weight1.5_v0.pt')

from sklearn.metrics import confusion_matrix, ConfusionMatrixDisplay
import matplotlib.pyplot as plt

def evaluate_confusion_matrix(model, val_loader, threshold=0.5):
    model.eval()
    all_preds = []
    all_labels = []
