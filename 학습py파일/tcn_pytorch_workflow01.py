# -*- coding: utf-8 -*-
"""TCN_pytorch_workflow01.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZnO4lqQT3jWQytrQj0ukJzob9kCif42V
"""
...
# 전체 경로 및 패턴 설정 (하위 폴더까지 포함)
BASE_DIR = '/content/drive/MyDrive/gesture_data_v3/'
file_pattern = "**/hybrid_typing_data_v3_*.csv"  # 모든 하위 폴더 포함
all_files = glob.glob(os.path.join(BASE_DIR, file_pattern), recursive=True)

if not all_files:
    print(f"'{BASE_DIR}' 폴더의 하위 폴더에서 '{file_pattern}' 패턴과 일치하는 파일을 찾을 수 없습니다.")
    print("Colab 왼편의 파일 탐색기를 통해 업로드 상태를 다시 확인하세요.")
else:
    # CSV 파일 읽고 합치기
...
# 5. 훈련된 기준 모델 저장
BASELINE_MODEL_PATH = 'baseline_model_tcn_30ver.pt'
...
BALANCED_DATASET_PATH = 'balanced_dataset_tcn_30ver.npz'
np.savez_compressed(
...
# 3. 훈련 루프 실행
best_f1_score = 0.0
FINAL_MODEL_PATH = 'final_model_tcn_30ver.pt'
